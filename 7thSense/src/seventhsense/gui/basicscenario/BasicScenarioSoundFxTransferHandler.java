...
public class BasicScenarioSoundFxTransferHandler extends AbstractBasicScenarioTransferHandler<SoundFxItem>
{
	 ...
	 */
	public BasicScenarioSoundFxTransferHandler(final BasicScenarioSoundFxPanel editorPanel)
	{
		super(editorPanel, SoundFxTransferable.SOUNDFX_TRANSFERABLE_FLAVOR);
	}

	@Override
	protected Transferable createTransferable(final JComponent c)
	{
		return new SoundFxTransferable(new SoundFxItem[]{_editorPanel.getSelectedItem()});
	}
}
